...
We conducted a F-Test to test whether the two variances are equal. We fail to reject the null hypothesis that the variances are the same since p-value is 0.3418, quite large and the 95% confidence interval involves the value 1.
